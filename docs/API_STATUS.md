...
|-------|-----|------|--------|--------------|------|
| Inventory API | Inventory API | Sandbox | Unresolved | Tue Apr 21 2026 | [Details](https://developer.ebay.com/support/api-status/Sandbox/publishoffer-api-is-returning-500-system-error) |
...
*Generated by [backend-services sidecar](https://github.com/Ubuntufoo/backend-services/tree/main/services/sidecar) API status sync.*
