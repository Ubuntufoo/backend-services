...
| 9J.9 | FE | Add pricing provider dashboard selector per listing | Dashboard segmented control selects Pricing Off, SoldComps, or Apify; reflects persisted mode and handles loading, saving, disabled, and backend configuration-error states |
| 9J.10 | FE | Add keyword modifier inputs per listing | Users can specify search criteria for pricing queries that include the default "-<modifier>" keywords. This allows for more targeted and accurate pricing results for graded slabs, prizms, variants |
