-- Manual rollback for YP5.3 Slice B confirmation activation.
-- Restores the Slice A confirmation function definition only; it does not rewrite durable group lifecycle data.
begin;
